 ...
 * Gpio.h
 *
 * Description: Public API for STM32F401xE GPIO Driver
...
/* Default States (Pull-Up/Down for Inputs, OType for Outputs) */
#define GPIO_PUSH_PULL    0x00
#define GPIO_OPEN_DRAIN   0x01

#define GPIO_NO_PULL      0x00
#define GPIO_PULL_UP      0x01
#define GPIO_PULL_DOWN    0x02  // CRITICAL for our Proteus Buttons/Sensors!
...
#define GPIO_AF1    0x01U  /* TIM1 / TIM2 (We need this for Motor PWM on PA8) */
#define GPIO_AF2    0x02U  /* TIM3 / TIM4 / TIM5 */
#define GPIO_AF3    0x03U  /* TIM9 / TIM10 / TIM11 */
#define GPIO_AF4    0x04U  /* I2C1 / I2C2 / I2C3 */
#define GPIO_AF5    0x05U  /* SPI1 / SPI2 / SPI3 / SPI4 (We need this for IPC on PA4-7) */
#define GPIO_AF6    0x06U  /* SPI3 */
#define GPIO_AF7    0x07U  /* USART1 / USART2 (We need this for Telemetry on PA2) */
